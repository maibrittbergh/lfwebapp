...
server= function(input, output, session){
  ...
  output$table_input=DT::renderDataTable({
    DT::datatable(data, selection='single', rownames=FALSE,colnames= c("GRDC No."="grdc_no" , "River"=   "river"   ,"Station"=   "station", "Country"=    "country",
                                                                       "Catchm. Area"="catch_area", "Altitude"= "altitude" ,"Startday"="startday", "Endday"="endday", "Start year"= "startyear" , "End year"= "endyear" ,
                                                                       "Timespan"=   "d_years"   , "Longitude"= "longitude"  , "Latitude"="latitude"   ), filter="top",
